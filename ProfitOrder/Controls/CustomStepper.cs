...
public class CustomStepper : StackLayout
{
    public static readonly BindableProperty ItemNoProperty =
        BindableProperty.Create(nameof(ItemNo), typeof(int), typeof(CustomStepper), 0);

    public static readonly BindableProperty QtyOrderProperty =
        BindableProperty.Create(nameof(QtyOrder), typeof(int), typeof(CustomStepper), 0);

    public static readonly BindableProperty UOMProperty =
        BindableProperty.Create(nameof(UOM), typeof(string), typeof(CustomStepper), string.Empty);

    public static readonly BindableProperty TextProperty =
        BindableProperty.Create(nameof(Text), typeof(int), typeof(CustomStepper), 0, BindingMode.TwoWay);

    public static readonly BindableProperty IsStepperVisibleProperty =
        BindableProperty.Create(nameof(IsStepperVisible), typeof(bool), typeof(CustomStepper), false, BindingMode.TwoWay);

    public static readonly BindableProperty IsAddToOrderVisibleProperty =
        BindableProperty.Create(nameof(IsAddToOrderVisible), typeof(bool), typeof(CustomStepper), false, BindingMode.TwoWay);

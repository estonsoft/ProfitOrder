    ...
    public class CustomStepperSmall : StackLayout
    {
        ...
        public CustomStepperSmall()
        {
            ...
            */
            ...
            QtyLabel = new Label { WidthRequest = 40, Margin = new Thickness(0, 2, 0, 0), TextColor = Colors.Black, FontSize = 16, FontAttributes = FontAttributes.Bold, HorizontalOptions = LayoutOptions.CenterAndExpand, HorizontalTextAlignment = TextAlignment.Center };
            ...
            InCartLabel = new Label { Text = "In Cart", WidthRequest = 35, Margin = new Thickness(0, -10, 0, 0), TextColor = Colors.Gray, FontSize = 8, HorizontalOptions = LayoutOptions.CenterAndExpand, HorizontalTextAlignment = TextAlignment.Center, MaxLines = 1 };

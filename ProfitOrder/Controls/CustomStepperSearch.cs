namespace ProfitOrder.Controls
{
    public class CustomStepperSearch : StackLayout
    {
        ...
        public CustomStepperSearch()
        {
            ...
            AddToOrderBtn = new Button { Text = "Add To Order", HeightRequest = 33, WidthRequest = 120, CornerRadius = 15, Margin = new Thickness(0, 11, 0, 0), Padding = new Thickness(0, 0, 0, 0), TextTransform = TextTransform.None, FontSize = 16, FontAttributes = FontAttributes.Bold, BackgroundColor = Colors.LightGray, TextColor = Colors.Blue};
            ...
            /*
            Entry = new Entry { PlaceholderColor = Colors.Gray, Keyboard = Keyboard.Numeric, WidthRequest = 30, BackgroundColor = Colors.Transparent, FontSize = 20 };
            ...
            */
            ...
            QtyLabel = new Label { WidthRequest = 35, Margin = new Thickness(0, 13, 0, 0), TextColor = Colors.Black, FontSize = 20, FontAttributes = FontAttributes.Bold, HorizontalOptions = LayoutOptions.CenterAndExpand, HorizontalTextAlignment = TextAlignment.Center };
            ...
            InCartLabel = new Label { Text = "In Cart", WidthRequest = 35, Margin = new Thickness(0, -9, 0, 0), TextColor = Colors.Gray, FontSize = 10, HorizontalOptions = LayoutOptions.CenterAndExpand, HorizontalTextAlignment = TextAlignment.Center, MaxLines = 1 };
